	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryings VertexFunction( Attributes input  )
			{
				...
				output.ase_texcoord9.xyz = input.texcoord.xyz;
						 ...
						 ) : SV_Target
			{
				...
				float2 uv_StarsTexture = input.ase_texcoord9.xyz.xy * _StarsTexture_ST.xy + _StarsTexture_ST.zw;
				float2 panner65 = ( 1.0 * _Time.y * _StarsSpeed + ( ( uv_StarsTexture * _StarsTile ) * _StarsTileOverall ));
				float2 uv_StarsNoiseTexture = input.ase_texcoord9.xyz.xy * _StarsNoiseTexture_ST.xy + _StarsNoiseTexture_ST.zw;
		...
		Pass
		{
			...
			PackedVaryings VertexFunction( Attributes input  )
			{
				...
				output.ase_texcoord5.xyz = input.texcoord0.xyz;
			...
			half4 frag(PackedVaryings input  ) : SV_TARGET
			{
				...
				float3 hsvTorgb4_g2 = RGBToHSV( ( _FresnelColor * saturate( staticSwitch62 ) ).rgb );
				float3 hsvTorgb8_g2 = HSVToRGB( float3(( hsvTorgb4_g2.x + _FresnelHueShift ),( hsvTorgb4_g2.y + 0.0 ),( hsvTorgb4_g2.z + 0.0 )) );
				float2 uv_StarsTexture = input.ase_texcoord5.xyz.xy * _StarsTexture_ST.xy + _StarsTexture_ST.zw;
				float2 panner65 = ( 1.0 * _Time.y * _StarsSpeed + ( ( uv_StarsTexture * _StarsTile ) * _StarsTileOverall ));
				float2 uv_StarsNoiseTexture = input.ase_texcoord5.xyz.xy * _StarsNoiseTexture_ST.xy + _StarsNoiseTexture_ST.zw;
				float2 panner68 = ( 1.0 * _Time.y * _StarsNoiseSpeed + ( ( uv_StarsNoiseTexture * _StarsNoiseTile ) * _StarsNoiseTileOverall ));
				float4 tex2DNode32 = tex2D( _StarsNoiseTexture, panner68 );
				float4 tex2DNode28 = tex2D( _StarsTexture, ( panner65 + ( _StarsDistortion * tex2DNode32.g ) ) );
				float4 lerpResult26 = lerp( _StarsColor01 , _StarsColor02 , saturate( ( ( tex2DNode28.g * tex2DNode32.g ) * 30.0 ) ));
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;88;0,100;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;MotionVectors;0;10;MotionVectors;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;False;False;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=MotionVectors;False;False;0;;0;0;Standard;0;False;0
...
ASEEND*/
//CHKSM=7BB5F2AD750055F0B8CAA71EE86F5619125EEB8B